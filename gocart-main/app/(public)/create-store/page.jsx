            ...
            if(['approved', 'pending', 'rejected'].includes(data.status)){
                ...
                switch(data.status){
                    case 'approved':
                        ...
                        break; 
                    case 'rejected':
                    setMessage("Your store has been rejected. Please contact admin support for more information.");
                    // No redirect - let them stay on this page or go back home
                    break; 
                case 'pending':
                    setMessage("Your store is pending, please wait for admin approval.");
                    // No redirect - let them stay on this page
                    break;
